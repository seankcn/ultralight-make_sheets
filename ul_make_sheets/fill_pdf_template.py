...
from ul_make_sheets.forms import mod_str
...
def create_character_pdf_template(character, basename):
...
def make_pdf(fields: dict, src_pdf: str, basename: str):
    ...
    Does so by updating each individual annotation with the contents of the fields.
