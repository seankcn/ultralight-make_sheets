...
from ul_make_sheets import exceptions
from ul_make_sheets.stats import Ability, ArmorClass, Initiative, Speed, Skill
...
class Content(ABC):
    ...
    """
    ul_make_sheets_version = __version__
    ...
    def _resolve_mechanic(mechanic, SuperClass, warning_message=None):
        ...
        used by a character::
            ...
            >>> from ul_make_sheets import spells
