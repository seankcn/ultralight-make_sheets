...
from ul_make_sheets.content import Creature
from ul_make_sheets.content_registry import find_content
from ul_make_sheets.dice import combine_dice
...
class Character(Creature):
    ...
    def set_attrs(self, **attrs):
        ...
        for attr, val in attrs.items():
            if attr == "ul_make_sheets_version":
    ...
    def wear_armor(self, new_armor):
        ...
        :py:class:`~ul_make_sheets.armor.Armor` is retrived from the
        ``armor.py`` file. Otherwise, an subclass of
        :py:class:`~ul_make_sheets.armor.Armor` can be provided
        directly.
    ...
    def wield_shield(self, shield):
        ...
        If a string is given, then a subclass of
        :py:class:`~ul_make_sheets.armor.Shield` is retrived from the
        ``armor.py`` file. Otherwise, an subclass of
        :py:class:`~ul_make_sheets.armor.Shield` can be provided
        directly.
    ...
    def to_pdf(self, filename, **kwargs):
        from ul_make_sheets.make_sheets import make_sheet
