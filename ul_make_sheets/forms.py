...
from ul_make_sheets.stats import mod_str, ability_mod_str, stat_abbreviation, str_to_list
from ul_make_sheets.monsters import challenge_rating_to_xp
...
def jinja_environment():
    ...
    jinja_env = Environment(
        loader=PackageLoader("ul_make_sheets", "forms"),
        block_start_string="[%",
        block_end_string="%]",
